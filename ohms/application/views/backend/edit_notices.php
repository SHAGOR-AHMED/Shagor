							...
							<form name="user" class="form-horizontal" id="user-submit" action="<?php echo base_url('Notice/update_notices'); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<div class="clearfix">
											<input type="text" name="purpose_notice" class="col-xs-12 col-sm-4" required="required" value="<?= $notices->purpose_notice; ?>" placeholder="Purpose of Notice" />
								...
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-9">
										<div class="clearfix">
											<textarea name="notices" class="col-xs-12 col-sm-4" required="required" placeholder="Notice"><?= $notices->notices; ?></textarea>
											&nbsp;&nbsp;<span class="fa fa-asterisk red"></span>
										</div>
									</div>
								</div>

								<input type="hidden" name="notice_id" class="col-xs-12 col-sm-4" required="required" value="<?= $notices->notice_id; ?>" />
